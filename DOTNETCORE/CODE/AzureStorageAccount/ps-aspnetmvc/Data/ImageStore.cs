...
namespace PSAspNetMvc.Data
{
    public class ImageStore
    {
        public ImageStore()
        {
            _client = new CloudBlobClient(_baseUri, new StorageCredentials("dukestorageaccount", "qE89HwlG1uPrTMINN1L0tlcGq71J/QymYWnEB5gCFpjtKAfHevSv3aNTcA9Ze8Vzj+7QzHm/071RsBTRy2Zh4w=="));
        }
        ...
        Uri _baseUri = new Uri("https://dukestorageaccount.blob.core.windows.net/");
